...
public class BlockAnalyzer {
    /**
     * Instantiation into different blocks according to the type of Stmt,
     * note that there are no five base blocks generated here
     * @param sootClass
     * @param block
     * @param methodBody
     * @return
    ...
    /**???没有剔除掉原来的块吗
     * Analyze which of the blocks generated in the previous function are loop blocks
     * @param methodBody
     * @param allBlocks
     * @param loop
     * @return
    ...
    /**
     * Analyze which of the blocks generated in the first function are trap blocks
     * @param methodBody
     * @param allBlocks
     * @param trap
     * @return
