...
public class MutationHelper {
    ...
    /**
     * Insert mutant, a base block from the base block set mutants, into the statement unit targetUnit in the targetMethodBody
     * @param seedClass
     * @param targetMethodBody
     * @param targetUnit
     * @param mutants
     * @param mutant
     */
...
//        }
        // Perform the corresponding insert method according to the type of the base block
        ...
        if (mutant.getValidStmts().size() > 0){
            ...
            for (Unit validStmt : mutant.getValidStmts()) {
                if (targetMethodBody.getUnits().contains(validStmt)) {
                    ...
                    DTGlobal.getInsertInfo().add(String.valueOf(validStmt));
            ...
            if (((StmtBlockInfo) mutant).getGotoStmt() != null){
                ...
                Random random = new Random(Configuration.randomSeed);
                IfStmt ifStmt = null;
                ...
                DTGlobal.getInsertInfo().add(String.valueOf(ifStmt));
...
//            targetMethodBody.getUnits().insertBefore(mutant.getValidStmts(), targetUnit);
        ...
        if (switchUnit instanceof JLookupSwitchStmt){
            ...
            DTGlobal.getInsertInfo().add(String.valueOf(switchStmt));
    ...
    public static void insertSuccsBlockInfo(BlockInfo invokeBlock, Body targetMethodBody, Unit targetUnit,List<BlockInfo> mutants, BlockInfo currentBlock){
        ...
        if (currentBlock instanceof StmtBlockInfo){
            ...
            if ( ((StmtBlockInfo)currentBlock).getGotoStmt() != null){
                ...
                DTGlobal.getInsertInfo().add(String.valueOf(newGotoStmt));
                targetMethodBody.getUnits().insertBeforeNoRedirect(newGotoStmt, targetUnit);
            ...
            if (invokeBlock instanceof TrapStmtBlockInfo){
                ...
                if(invokeBlock == currentBlock) {
                    ...
                    if (targetMethodBody.getUnits().contains(((TrapStmtBlockInfo) currentBlock).getHandlerUnitBox())){
                        ...
                        DTGlobal.getInsertInfo().add(String.valueOf(((TrapStmtBlockInfo) currentBlock).getHandlerUnitBox()));
...
//                Local tmp = getVarWithTypeAndUpdateVarName(targetMethodBody.getLocals(), depensLocal);
                ...
                if (tmp != null){
                    DTGlobal.getInsertInfo().add(String.valueOf(new JAssignStmt(depensLocal,tmp)));
                    ...
                    if(PrimitiveProvider.isPrimitiveOrString(depensLocal.getType())){
                        ...
                        DTGlobal.getInsertInfo().add(String.valueOf(new JAssignStmt(depensLocal,newValue)));
                        ...
                        if (array.numDimensions > 1){
                            ...
                            DTGlobal.getInsertInfo().add(String.valueOf(unit));
    ...
    public static boolean insertInitialStmt(Body targetMethodBody, Unit targetUnit, SootClass sootClass, Local dependLocal, int depth){
        ...
        if (constructor != null){
            ...
            DTGlobal.getInsertInfo().add(String.valueOf(newStmt));
            ...
            DTGlobal.getInsertInfo().add(String.valueOf(invokeStmt));
        ...
        if (constructors.size() > 0){
            ...
            int index = new Random(Configuration.randomSeed).nextInt(constructors.size());
